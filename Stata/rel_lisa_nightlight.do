...
gen secondary_percent = (((popn_secondary+popn_highschool+popn_graduate+popn_post_graduate)/popn_2021) * 100)


gen high_school_percent= (((popn_highschool+popn_graduate+popn_post_graduate)/popn_2021) * 100)

gen graduate_percent= (((popn_graduate+popn_post_graduate)/popn_2021) * 100)
...
gen rel_lisa = lisa_avg - ben_mark_lisa
//initial regression

regress rel_chgnl  log_baseline_nl, r
outreg2 using v4_intial_regression.doc, replace dec(3)

regress rel_chgnl  log_baseline_nl rel_lisa, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl  log_baseline_nl rel_lisa high_school_percent, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl  log_baseline_nl rel_lisa high_school_percent, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl  log_baseline_nl rel_lisa high_school_percent ageatelection, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl  log_baseline_nl rel_lisa high_school_percent ageatelection gov_coalitiion, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl  log_baseline_nl rel_lisa high_school_percent ageatelection gov_coalitiion female, r
outreg2 using v4_intial_regression.doc, append dec(3)
