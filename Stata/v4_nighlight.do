...
regress rel_chgnl lisa_avg, r
outreg2 using v4_intial_regression.doc, replace dec(3)

regress rel_chgnl lisa_avg high_school_percent, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl lisa_avg high_school_percent, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl lisa_avg high_school_percent ageatelection, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl lisa_avg high_school_percent ageatelection gov_coalitiion, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl lisa_avg high_school_percent ageatelection gov_coalitiion female, r
outreg2 using v4_intial_regression.doc, append dec(3)

regress rel_chgnl lisa_avg high_school_percent ageatelection gov_coalitiion female ln_popn, r
outreg2 using v4_intial_regression.doc, append dec(3)
...
regress rel_chgnl gov_magm_avg, r
outreg2 using v4_lisa_regression.doc, replace dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg, r
outreg2 using lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl  gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg jud_exe_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg jud_exe_avg phy_infra_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg jud_exe_avg phy_infra_avg soc_inc_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg jud_exe_avg phy_infra_avg soc_inc_avg env_protec_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg jud_exe_avg phy_infra_avg soc_inc_avg env_protec_avg cop_cor_avg, r
outreg2 using v4_lisa_regression.doc, append dec(3)

regress rel_chgnl gov_magm_avg org_admin_avg budg_magm_avg fiscal_magm_avg service_dev_avg jud_exe_avg phy_infra_avg soc_inc_avg env_protec_avg cop_cor_avg high_school_percent, r
outreg2 using v4_lisa_regression.doc, append dec(3)

// revised regression

regress rel_chgnl phy_infra_avg, r
outreg2 using v4_revised_regression.doc, replace dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg, r
outreg2 using v4_revised_regression.doc, append dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg high_school_percent, r
outreg2 using v4_revised_regression.doc, append dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg high_school_percent ageatelection, r
outreg2 using v4_revised_regression.doc, append dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg high_school_percent ageatelection female, r
outreg2 using v4_revised_regression.doc, append dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg high_school_percent ageatelection female, r
outreg2 using v4_revised_regression.doc, append dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg high_school_percent ageatelection female gov_coalitiion, r
outreg2 using v4_revised_regression.doc, append dec(3)

regress rel_chgnl phy_infra_avg cop_cor_avg high_school_percent ageatelection female gov_coalitiion ln_popn, r
outreg2 using v4_revised_regression.doc, append dec(3)
...
//
// regress rel_chgnl_2 lisa_avg, r
// eststo model1
//
// regress rel_chgnl_2 lisa_avg log_baseline_nl ln_educ, r
// eststo model2
//
// regress rel_chgnl_2 lisa_avg log_baseline_nl ln_educ ln_popn, r
//
// regress rel_chgnl_2 lisa_avg log_baseline_nl high_school_percent, r
//
//
